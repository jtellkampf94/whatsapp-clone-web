...
var IconButton = /*#__PURE__*/external_react_.forwardRef(function IconButton(props, ref) {
  ...
  return /*#__PURE__*/external_react_.createElement(ButtonBase_ButtonBase, _extends({
    className: external_clsx_default()(classes.root, className, color !== 'default' && classes["color".concat(capitalize(color))], disabled && classes.disabled, size === "small" && classes["size".concat(capitalize(size))], {
